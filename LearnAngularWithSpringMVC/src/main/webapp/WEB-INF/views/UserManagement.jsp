...
<html>
  ...
  <body ng-app="myApp" class="ng-cloak">
	...
	<!--modal -->
		<button type="button" class="btn btn-info custom-width" data-toggle="modal" data-target="#myModal">New</button>
      <br>
      <br>
				    ...
				    <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
				      ...
				      <div class="row">
				        <div class="form-actions floatRight" >
				          <input type="submit" value="{{!ctrl.user.id ? 'Add' : 'Update'}}" onclick="$('.modal').modal('hide')" class="btn btn-primary btn-sm" ng-disabled="myForm.$invalid"  >
                  ...
                  <table class="table table-hover">
                      ...
                      <tbody>
                          <tr ng-repeat="u in ctrl.users">
                              ...
                              <td>
                              <button type="button" ng-click="ctrl.edit(u.id)" onclick="$('.modal').modal('show')" class="btn btn-success custom-width">Edit</button>  
